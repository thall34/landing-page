...
<img src="./screenshots/logo-bar.png" alt="logo bar element" width="700">
4. Main content ends with a fictional quote about the company.
<img src="./screenshots/quote.png" alt="quote element" width="700">
5. There is a contact bar at the bottom with another contact button (for decoration).
<img src="./screenshots/contact-bar.png" alt="contact bar element" width="700">
